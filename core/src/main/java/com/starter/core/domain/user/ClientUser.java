...
public class ClientUser extends User {
    ...
    private ClientUser(String email, String name, String nickname, Gender gender, LocalDate birthday, String phoneNumber) {
    ...
    public static ClientUser createClientUser(String email, String name, String nickname, Gender gender, LocalDate birthday, String phoneNumber) {

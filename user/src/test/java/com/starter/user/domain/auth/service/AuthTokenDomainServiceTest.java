...
import com.starter.place.config.payload.exception.NotExistDataException;
...
import com.starter.user.domain.auth.AuthTokenMock;
...
class AuthTokenDomainServiceTest extends DomainServiceTest {
    ...
    void saveAuthToken() {
        ...
        UUID authTokenId = authTokenDomainService.saveAuthToken(1,
